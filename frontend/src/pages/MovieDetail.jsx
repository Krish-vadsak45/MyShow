...
const MovieDetail = () => {
  ...
  }, [user, axios, id, fetchFavouriteMovies]);

  const castList = useMemo(() => {
    if (!show?.movie?.cast) return [];
    return getUniqueBy(
    ...
    <>
      <div className="px-6 md:px-16 lg:px-40 pt-30 md:pt-50">
        ...
        <button
          ...
          className="flex justify-center mt-20 mb-10 lg:mb-20 mx-auto px-10 py-3 text-sm bg-primary hover:bg-primary-dull transition rounded-md font-medium cursor-pointer"
        >
          Show More
        </button>
      </div>
