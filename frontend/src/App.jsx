  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route
          path="/movies"
          element={withSkeleton(<Movies />, <MoviesSkeleton />)}
        />
        <Route
          path="/movies/:id"
          element={withSkeleton(<MovieDetail />, <MovieDetailSkeleton />)}
        />
        <Route
          path="/movies/:id/:date"
          element={withSkeleton(<SeatLayout />, <SeatLayoutSkeleton />)}
        />
        <Route
          path="/upcoming"
          element={withSkeleton(<Upcoming />, <UpcomingSkeleton />)}
        />
        <Route
          path="/mybookings"
          element={withSkeleton(<MyBookings />, <MyBookingsSkeleton />)}
        />
        <Route
          path="/favourite"
          element={withSkeleton(<Favourite />, <FavouriteSkeleton />)}
        />
        <Route
          path="/aboutus"
          element={withSkeleton(<AboutUs />, <AboutUsSkeleton />)}
        />
